...
use App\Http\Requests\Payout_logRequest as StoreRequest;
use App\Http\Requests\Payout_logRequest as UpdateRequest;
use App\Backpack\Crud\MyCrudPanel;

class Payout_logCrudController extends CrudController {
	...
	public function setUp() {
		...
		*/
        ...
        $this->crud->addFilter([
            ...
            false,
            function($value) {
                $this->crud->addClause('where', 'payout_id', $value);
            });

...
use App\Http\Requests\LogRequest as StoreRequest;
use App\Http\Requests\LogRequest as UpdateRequest;
		...
		*/
        ...
        $this->crud->addFilter([
            ...
            [
                ...
                'PrepareOnlinePayment' => 'PrepareOnlinePayment',
                'insertTransaction' => 'insertTransaction',
                'GetPriceStudentDiscountInfo' => 'GetPriceStudentDiscountInfo',
                'CancelPurchase' => 'CancelPurchase',
                'GetTransactionStatus' => 'GetTransactionStatus',
                'Internet_GetPlaceBytest' => 'Internet_GetPlaceBytest',
            ],
            function( $value ) {
                if( $value ){
        ...
        $this->crud->addFilter([
            ...
            false,
            function($value) {
                $this->crud->addClause('where', 'ticket_id', $value);
            });

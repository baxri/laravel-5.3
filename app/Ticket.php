...
class Ticket extends RaModel
{
    ...
    public function toArray()
    {
        ...
        return [
           ...
           'start_date' => Railway::translateDate( $this->start_datetime ),
           ...
           'allow_return_ticket' => $due_datetime_for_searching->diffInMinutes($this->start_datetime),
    ...
    public function authorized( $token = null ){
        ...
        if( strlen($this->action_token) < 10 ){
            return false;
        }
